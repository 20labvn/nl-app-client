                            ...
                            <a href=".">
                                <svg xmlns="http://www.w3.org/2000/svg" width="110" height="32" viewBox="0 0 232 68"
                                    ...
                                    <path
                                        ...
                                        fillRule="evenodd" clipRule="evenodd" fill="#4a4a4a"></path>
                                </svg>
                            </a>
                        </div>
                        <div className="navbar-nav flex-row order-md-last">
                            <div className="nav-item d-none d-md-flex me-3">
                                <div className="btn-list">
                                    <a href="https://github.com/tabler/tabler" className="btn" target="_blank"
                                       rel="noreferrer">
                                        Home
                                    </a>
                                    <a href="https://github.com/sponsors/codecalm" className="btn" target="_blank"
                                       rel="noreferrer">
                                        Contact
                                    </a>
                                    <a href="https://github.com/sponsors/codecalm" className="btn" target="_blank"
